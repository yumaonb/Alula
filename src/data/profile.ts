...
/** 首页自我介绍（支持 HTML） */
export const intro = `
  <p>这里是羽毛的小屋，一位热爱探索的学生。</p>
  <p>本项目技术栈：Astro · Vue 3 · TypeScript</p>
  <p>源码已开源至github：<a href="https://github.com/yumaonb/YuSwift/" target="_blank" rel="noopener">点我前往项目地址</a></p>
  <p>本站随时可能更换域名，建议收藏项目地址或收藏中转页：<a href="https://yumaonb.github.io/" target="_blank" rel="noopener">yumaonb.github.io</a></p>
`;
